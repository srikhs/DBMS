...
<script type="text/javascript">
    ...
    var request1 = {
			origin:location1, 
			destination:'37.807614,-122.420768',
			travelMode: google.maps.DirectionsTravelMode.DRIVING
		};
   ...
   directionsService.route(request1, function(response1, status) 
        ...
        distance = "The distance between the two points on the chosen route is: "+response1.routes[0].legs[0].distance.text;
				distance += "<br/>The aproximative driving time is: "+response1.routes[0].legs[0].duration.text;
				document.getElementById("distance_road1").innerHTML = distance;
...
?>
 ...
 <center><div style="width:100%; height:10%" id="distance_road1"></div></center>
