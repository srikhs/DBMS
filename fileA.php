...
$sql2='SELECT j.BlockId,i.Intersection, ( 3959 * ACOS( COS( RADIANS( 37.8064357 ) ) * COS( RADIANS( j.Latitude2 ) ) * COS( RADIANS( j.Longitude2 ) - RADIANS( -122.4231005 ) ) + SIN( RADIANS( 37.8064357 ) ) * SIN( RADIANS( j.Latitude2 ) ) ) ) AS distance
...
?>
	...
	<div id="form" style="width:100%; height:20%">
		<table align="center" valign="center">
			...
			<tr>
				<td colspan="7" align="center"><input type="button" value="Show" onclick="showUser(document.getElementById('address2').value);"/></td>
			</tr>
		</table>
	</div>
