...
$sql2='SELECT Intersection, ( 3959 * ACOS( COS( RADIANS( 37.806249 ) ) * COS( RADIANS( Latitude ) ) * COS( RADIANS( Longitude ) - RADIANS( - 122.423884 ) ) + SIN( RADIANS( 37.806249 ) ) * SIN( RADIANS( Latitude ) ) ) ) AS distance
FROM TABLE1
HAVING distance <805
